...
void WiFiLocalWebPageCtrl(void)
{
  ...
  /*            client.print("Temperature now is: ");
              ...
              /* Aspecto HTML da pagina*/
              
              client.print("<html>");
              client.print("<meta charset=""UTF-8"">"); //portuguese chars
              client.print("<head>");
              client.print("<style>");
              client.print("a {color:blue;}");
              client.print("h1 {color:red;}");
              client.print(".botao");                            
              client.print("{");
              client.print("background-color:#C7C7C7;");
              ...
              client.println("<div style=""background-color:lightblue""><center>");
              client.print("<br><a href=""/SEQ1""><button>Sequência 1</button><class=""botao""></a>");
              client.println("&nbsp");
              client.print("<a href=""/SEQ2""><button>Sequência 2</button></a>");
              client.println("&nbsp<br><br>");
              client.print("<a href=""/SEQ3""><button>Sequência 3</button></a>");
              client.println("&nbsp");
              client.print("<a href=""/SEQ4""><button>Sequência 4</button></a>");         
        ...
        if (currentLine.endsWith("GET /SEQ4")) {
